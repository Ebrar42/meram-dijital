    ...
    <div className="contact-container" >
        ...
        <div className='contact-form'>
            ...
            <form onSubmit={handleSubmit}>
                ...
                <input type="email" placeholder='E posta Adresiniz' value={formData.email} onChange={handleChange} />
                <textarea type="massage" placeholder='Mesajınız' value={formData.message} onChange={handleChange} required ></textarea>
