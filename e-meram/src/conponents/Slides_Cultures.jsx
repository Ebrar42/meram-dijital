        ...
        <div className='container'>
            ...
            <div id='carouselExampleCaptions' className="carousel slide">
                <div className="carousel-indicators" >
                    ...
                    ></button>
                    <button type='button'
                    ata-bs-target="#carouselExampleCaptions"
                    data-bs-slide-to="2"
                    aria-label="Slide 3"
                    ></button>
                </div>
                <div className='carousel-inner'>
                    ...
                    <div  className="carousel-item">
                        <Link to="/ates-bazi-veli-turbesi">
                            <img src="https://cdn.gokonya.com/other/atesbazi-veli-turbesi-3.jpg" 
                             className="d-block w-100"
                             style={{ objectFit: "cover", height: "550px" }}
                             alt="..." />
                        </Link>
                        <div lassName="carousel-caption d-none d-md-block contor">
                    ...
                    <div className="carousel-item">
                        <Link to="/kapucamii" >
                            <img src="https://www.yenikonya.com.tr/uploads/2023/07/20/568c4d01_big.jpg"
                            className="d-block w-100"
                            style={{ objectFit: "cover", height: "550px" }}
                            alt="..." />
                        </Link>
...
export default Slides_Cultures