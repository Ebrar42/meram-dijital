...
function Slides_Restaurants() {
  return (
    <div className='container'>
        <div className='container cont'>
            <h2>RESTORANLAR</h2>
        </div>
        <div className='carousel slide' id='carsouselExampleCaptions1'>
            ...
            <div className='carousel-inner'>
                <div className='carousel-item active'>
                    <Link to='/camlibel'>
                        <img src="https://sepet.konya.bel.tr/kbb/kbb/bldfoto/17/kynk/cml_b_7.jpg"
                         alt="..."
                ...
                <div className='carousel-item'>
                    <Link to='/kirkikindi'>
                        <img src="https://media-cdn.tripadvisor.com/media/photo-s/28/ff/d4/e4/kirkikindi.jpg"
                         alt="..."
                         className="d-block w-100"
                         style={{ objectFit: "cover", height: "550px" }} />
                    </Link>
                ...
                <div className='carousel-item'>
                    <Link to='/huzur-kafe'>
                        <img src="https://universitev.com/front/companies_media/konya-meram-kafe-meram-huzur/478631662230674/20220903214434-478631662230674-media-1920x1309.webp"
                         alt=".." 
                         className="d-block w-100"
                         style={{ objectFit: "cover", height: "550px" }}/>
                    </Link>
...
export default Slides_Restaurants